...
/* ================= Shipping ================= */
const GOVERNORATES = [
  { value: "القاهرة", label: "القاهرة", fee: 80 },
  { value: "الجيزة", label: "الجيزة", fee: 80 },
  { value: "الإسكندرية", label: "الإسكندرية", fee: 80 },
  { value: "البحيرة", label: "البحيرة", fee: 80 },
  { value: "القليوبية", label: "القليوبية", fee: 80 },
  { value: "الغربية", label: "الغربية", fee: 80 },
  { value: "المنوفية", label: "المنوفية", fee: 80 },
  { value: "دمياط", label: "دمياط", fee: 80 },
  { value: "الدقهلية", label: "الدقهلية", fee: 80 },
  { value: "كفر الشيخ", label: "كفر الشيخ", fee: 80 },
  { value: "الشرقية", label: "الشرقية", fee: 70 },
  { value: "الشرقية - فاقوس", label: "الشرقية - فاقوس", fee: 35 },
  { value: "مطروح", label: "مطروح", fee: 135 },
  { value: "الإسماعيلية", label: "الإسماعيلية", fee: 95 },
  { value: "السويس", label: "السويس", fee: 95 },
  { value: "بورسعيد", label: "بورسعيد", fee: 95 },
  { value: "الفيوم", label: "الفيوم", fee: 110 },
  { value: "بني سويف", label: "بني سويف", fee: 110 },
  { value: "المنيا", label: "المنيا", fee: 110 },
  { value: "أسيوط", label: "أسيوط", fee: 115 },
  { value: "سوهاج", label: "سوهاج", fee: 130 },
  { value: "قنا", label: "قنا", fee: 130 },
  { value: "أسوان", label: "أسوان", fee: 130 },
  { value: "الأقصر", label: "الأقصر", fee: 130 },
  { value: "البحر الأحمر", label: "البحر الأحمر", fee: 130 },
  { value: "الوادي الجديد", label: "الوادي الجديد", fee: 135 },
  { value: "شمال سيناء", label: "شمال سيناء", fee: 135 },
  { value: "جنوب سيناء", label: "جنوب سيناء", fee: 135 },
];
